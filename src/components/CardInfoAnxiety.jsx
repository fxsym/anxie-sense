...
export const CardInfoAnxiety = ({ title, desc }) => {
    return (
        <>
            <div className="flex flex-col items-center bg-sky-200/80 backdrop-blur-sm p-6 m-4 my-8 rounded-2xl shadow-xl transition-all duration-500 lg:w-1/3 hover:shadow-black hover:shadow-2xl">
