...
export const ResultPrediction = ({ resultPrediction, loadingStatus, firstPredict }) => {
    ...
    return (
        <div className={`${firstPredict !== false ? "" : "hidden "} bg-emerald-100 shadow-2xl transition-all duration-200 rounded-2xl p-6 hover:shadow-black hover:shadow-2xl justify-center flex flex-col items-center  lg:gap-6 lg:p-6`}>
